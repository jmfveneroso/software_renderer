...
void EntityManager::DrawRock(
  int rock_id, 
  glm::mat4 ModelMatrix, glm::mat4 ProjectionMatrix, glm::mat4 ViewMatrix, 
  glm::vec3 color
) {
  rocks_[rock_id]->DrawShit(ModelMatrix, ProjectionMatrix, ViewMatrix, color, 0); 
}
