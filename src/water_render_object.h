...
class WaterRenderObject {
 ...
 public:
  ...
  static const float WAVE_SPEED = 0.01f;

  glm::vec3 position;

  WaterRenderObject() {}
  WaterRenderObject(const std::string& model, GLuint ReflectionTexture, GLuint RefractionTexture, const std::string& dudv_file, GLuint programID) {
...
float WaterRenderObject::move_factor = 0;
