...
_DEPS = src/shaders.h src/bitmap.h src/objloader.h src/controls.h src/render_object.h src/water_render_object.h src/tangentspace.h src/renderer.h src/water.h
